...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark " style="margin:0px!important;padding:0!important!">
    ...
    <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>AULAS
    </a>
            ...
            @if (auth()->user()->hasAnyRole(['superadmin', 'teacher', 'coordenador-curso']))
                <li class="nav-item dropdown li-nav">
                    <a class="nav-link dropdown-toggle a-first" href="#" id="navbarDropdown" role="button"
                        ...
                        <i class="fa-solid fa-person-chalkboard"></i>Aulas 
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">

                        <a class="dropdown-item" href="{{ route('lessons.create') }}"><i
                                class="fa-solid fa-person-chalkboard"></i>Nova</a>

                    </div>
                </li>
            @endif            

            @if (auth()->user()->hasAnyRole(['superadmin', 'teacher', 'student', 'coordenador-curso']))
                <li class="nav-item li-nav">
                    <a class="nav-link a-first a-second" style="width: 115px;" href="/gestao-academica/summaries">
                        <i class="fas"></i> Sumários 
                    </a>
                </li>
