                            ...
                            <tr>    
                             ...
                             @foreach($notas as $nota)
                               ...
                               <td class="text-center">{{$nota->value}}</td>
                                @if ($d==1)
                                    @php                     
                                        $somaNota[$item->id]=$nota->value;
                                     @endphp
                                @endif  
                                @if ($d==2)  
                                    @php  
                                        $d=0;
                                        $segundaNota[$item->id]=$nota->value;
                                    @endphp
                                    
                                    @php
                                      
                                    @endphp
                                   <td class="text-center">{{$segundaNota[$item->id]  <10 || $somaNota[$item->id] <10 ? "-": round(($somaNota[$item->id]+$nota->value++)/ 2) }}</td> 
                         
                                   <td class="text-center">{{$segundaNota[$item->id]  <10 || $somaNota[$item->id] <10 ? "Não admitido(a)": "Admitido(a)"}}</td>
                                 @endif
