                    ...
                    <table class="table_te" >
                        <style>
                            ...
                            .tabble_te thead{}
                             ...
                             <tr>    
                                <th class="text-center" style="font-size:18pt;font-weight:bold;">Curso</th>
                                <th class="text-center" style="font-size:18pt;font-weight:bold;">Turma</th>
                                <th class="text-center" style="font-size:18pt;font-weight:bold;">Total candidato(s)</th>
                                <th class="text-center" style="font-size:18pt;font-weight:bold;">Total vaga(s)</th>
                            </tr>
                             <tr>
                          
                                 <td class="text-center" style="background-color: #F9F2F4;">{{$curso}}</td>
                                 <td class="text-center" style="background-color: #F9F2F4;">{{$turmaC}}</td>
                                 ...
                                 @foreach ($model as $curso)
                                  @if($curso->state=="total")
                                   ...
                                   @endif
                                  @endforeach  
                                        <td class="text-center" style="background-color: #F9F2F4;">{{$count}}</td>  
                                        <td class="text-center" style="background-color: #F9F2F4;">{{$vagas_number}}</td>  
                            </tr>
                    ...
                    <div class="">
                        <div class="">
                            ...
                            <tr>    
                               ...
                               <td class="text-center">{{$item->nota==null?"S/N":$item->nota}}</td>

                               @if ($count>$vagas_number&& $item->nota>9)
                               @php
                                 $count =$vagas_number+1;
                               @endphp
                               <td class="text-center">{{$item->nota>9? "Suplente":""}}</td> 
                               @else
                               <td class="text-center">{{$item->nota>9? "Admitido(a)":"Não admitido(a)"}}</td> 
                               @endif
