...
<footer>
    <table class="tb_footer">
        ...
        <tr id="decima">
            <td >INSTITUTO SUPERIOR POLITÉCNICO MARAVILHA<br>
...
<td  class="text-right" id="tel">  <img class="iconeIMAg" src="https://img.icons8.com/ios-glyphs/50/000000/filled-message.png" />
  geral@ispm.co.ao | <img class="iconeIMAg" src="https://img.icons8.com/ios-glyphs/60/000000/phone-office--v1.png"/>+244 272 231 584 </td>      
        </tr>
        <tr>
