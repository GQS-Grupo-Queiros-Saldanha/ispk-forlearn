...
<html>
    <head>
        ...
        <style>
            ...
            footer{
                position: fixed;
                bottom: 30px; /* Posição mais baixa para aparecer */
                width: 100%;
            }
            .tb_footer{
                opacity:0.8;
    ...
    <body style="@if($requerimento->codigo_documento == 12) padding-top:30px; @endif">
        <footer style="
            ...
            position: fixed;
            bottom: 30px; /* Posição ajustada para aparecer */
            ">

            <table class="tb_footer">
                <style>#decima td{font-family:calibri light;@if($requerimento->codigo_documento == 2 || $requerimento->codigo_documento == 10)padding-left:135px; @else padding-left:0px;@endif}</style>
                <tr id="decima">
