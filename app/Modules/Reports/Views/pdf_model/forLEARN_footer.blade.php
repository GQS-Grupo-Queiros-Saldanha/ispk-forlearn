...
<html>
    <head>
        ...
        <style>
            ...
            footer{
                position: fixed;
                bottom: 10px; /* Ajuste esta valor para subir/descer o footer */
                width: 100%;
            }
            .tb_footer{
                opacity:0.8;
    ...
    @endif">
        <footer style="
            ...
            position: fixed;
            bottom: 15px; /* Ajuste este valor para subir mais ou menos */
            ">

            <table class="tb_footer">
                <style>#decima td{font-family:calibri light;@if($requerimento->codigo_documento == 2 || $requerimento->codigo_documento == 10)padding-left:135px; @else padding-left:0px;@endif  }.iconeIMAg{ height:18px;position:absolute;top:20px;}</style>
                <tr id="decima">
