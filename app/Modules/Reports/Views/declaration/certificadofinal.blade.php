    ...
    <main>
        ...
        <p style="font-size:14pt">
            ...
            <div>
                ...
                <p style="font-size:11pt  !important;margin-top:-25px!important;">{{ $direitor->categoria_profissional ?? 'Categoria Profissional' }}</p>
                <p style="font-size:11pt; !important;margin-top:5px!important;">{{ $direitor->cargo  ?? 'Cargo' }} do {{$institution->abrev}}</p>
