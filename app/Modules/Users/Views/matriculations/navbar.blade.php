...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark " style="margin:0px!important;padding:0!important!">
    ...
    <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>MATRÍCULAS
    </a>
    ...
    <div class="collapse navbar-collapse dropdown ani-d" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item  li-nav">
                            ...
                            href="/users/states-matriculation">
                                <i class="fas fa-user"></i>
                                Estados</a>
                        </li>
                        @endif
                        
                        @if (auth()->user()->hasAnyPermission(['lista_de_matriculados']) || auth()->user()->hasAnyRole(['superadmin']) )
                        <li class="nav-item dropdown li-nav">
                            <a class="nav-link dropdown-toggle a-first" href="#" id="navbarDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-list-alt"></i>Listagem de matriculados
                            </a>
                            <div class="dropdown-menu" style="width: -webkit-fill-available;" aria-labelledby="navbarDropdown">
            
                                    <a class="dropdown-item" href="{{ route('listagem-d-matriculation.index') }}"><i
                                            class="fas fa-list-alt"></i>Por disciplina</a>
                      
                                    <a class="dropdown-item" href="{{ route('listagem-classe-matriculation.index') }}"><i
                                            class="fas fa-list-alt"></i>Por turma</a>
                        ...
                        @if (auth()->user()->hasAnyPermission(['gerir_equivalência']))
                         <li class="nav-item  li-nav">
                            <a class="dropdown-item" target="_blank"
                           href="/users/matriculations-equivalence">
                        ...
                        @if (auth()->user()->hasAnyPermission(['Anular_matricula']) || auth()->user()->hasAnyRole(['superadmin' ]))
                         <li class="nav-item  li-nav">
                            <a class="dropdown-item" target="_blank"
                           href="{{route('anulate.matriculation.index')}}">
                                 <i class="fas fa-trash"></i>
                                    Matrículas anuladas
                                </a>
                        </li>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['estatistica_matriculados']) || auth()->user()->hasAnyRole(['superadmin' ]))
                        <div class="dropdown ani-d">
                            <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                style=" text-align: left!important;padding:13px;">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                                ...
                                <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                                    href="{{route('estatistica.matriculation.index')}}">
                                    <i class="fa fa-bar-chart"></i> Relatórios Matriculados
                                </a>
                            </div>
