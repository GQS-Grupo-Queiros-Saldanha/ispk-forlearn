      ...
      @endforeach
             ...
             <!-- Tabela para dados totais -->
              <table class="table_te" style="width:90%;margin-left:60px;">
                ...
                <tr>
                    <th class="text-center bg1 font-weight-bold f3 pd" colspan="4">1º</th>
                    <th class="text-center bg1 font-weight-bold f3 pd" colspan="4">2º</th>
                    <th class="text-center bg1 font-weight-bold f3 pd" colspan="4">3º</th>
                    <th class="text-center bg1 font-weight-bold f3 pd" colspan="4">4º</th>
                    <th class="text-center bg1 font-weight-bold f3 pd" colspan="4">5º</th>
                </tr>
                <tr>
                    <th class="text-center bg1 font-weight-bold f3 w32" colspan="2">Total</th>
                    <th class="text-center bg1 font-weight-bold f3 w16">m</th>
                    <th class="text-center bg1 font-weight-bold f3 w16">f</th>
                    <th class="text-center bg1 font-weight-bold f3 w32" colspan="2">Total</th>
                    <th class="text-center bg1 font-weight-bold f3 w16">m</th>
                    <th class="text-center bg1 font-weight-bold f3 w16">f</th>
                    <th class="text-center bg1 font-weight-bold f3 w32" colspan="2">Total</th>
                ...
                @foreach ($val as $key => $item)
                    ...
                    <tr class="last-line font-weight-bold">
                        <td class="bg-white f4" colspan="2"><b>SUB-TOTAL</b></td>
                        <td class="text-center bg3 f3" colspan="4">{{ $sub_t1 }}</td>
                        <td class="text-center bg3 f3" colspan="4">{{ $sub_t2 }}</td>
                        <td class="text-center bg3 f3" colspan="4">{{ $sub_t3 }}</td>
                        <td class="text-center bg3 f3" colspan="4">{{ $sub_t4 }}</td>
                        <td class="text-center bg3 f3" colspan="4">{{ $sub_t5 }}</td>
                        <td class="text-center bg8 f3">{{ $sub_t1 + $sub_t2 + $sub_t3 + $sub_t4 + $sub_t5 }}</td>
                    </tr>
                    <tr>
                        <td class="bg-white"></td>
                ...
                <tr class="last-line font-weight-bold">
                    ...
                    <td class="text-center bg3 f3" colspan="4">{{ $sub_t4_geral }}</td>
                    <td class="text-center bg3 f3" colspan="4">{{ $sub_t5_geral }}</td>
                    <td class="text-center bg8 f3">{{ $sub_t1_geral + $sub_t2_geral + $sub_t3_geral + $sub_t4_geral + $sub_t5_geral }}</td>
                </tr>
                <tr>
                    <td class="bg-white"></td>
                </tr>
