...
$documentoCode_documento = 50;
                             ...
                             if(MatriculationUtil::verificarPrimeiroAnoCurricularBoletim($matriculation_obj)){
                                $doc_name = 'Boletim de Matrícula';
                            }
                            else{
                                $doc_name = 'Boletim de renovação de Matrícula';
                            }
...
{{-- Novo modelo de apresentação --}}
    ...
    <main>
        ...
        @include('Users::matriculations.partials.report_partials')
