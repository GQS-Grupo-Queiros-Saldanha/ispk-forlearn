@switch($type)
@case('segunda_chamada')<title>Lista - Avaliações Contínuas (2ª chamada)</title>@break
...
@switch($type)
@case('segunda_chamada')@section('page-title', 'Lista - Avaliações Contínuas (2ª chamada)')@break
@case('recurso')@section('page-title', 'Lista do Exame de Recurso')@break
@case('exame_especial')@section('page-title', 'Lista do Exame Especial')@break
@case('melhoria_nota')@section('page-title', 'Lista do Exame de Melhoria de Nota')@break
@case('exame_extraordinario')@section('page-title', 'Lista do Exame Extraordinário')@break
@endswitch
...
@switch($type)
@case('segunda_chamada') <li class="breadcrumb-item active" aria-current="page">Lista - Avaliações Contínuas (2ª chamada)</li>@break
@case('recurso')<li class="breadcrumb-item active" aria-current="page">Lista do Exame de Recurso</li>@break
@case('exame_especial')<li class="breadcrumb-item active" aria-current="page">Lista do Exame Especial</li>@break
@case('melhoria_nota')<li class="breadcrumb-item active" aria-current="page">Lista do Exame de Melhoria de Nota</li>@break
@case('exame_extraordinario')<li class="breadcrumb-item active" aria-current="page">Lista do Exame Extraordinário</li>@break
@endswitch
...
<div class="row">
    <div class="col">
        ...
        {!! Form::open(['route' => ['student_evaluation_list_pdf',$type], 'method' => 'post', 'required' => 'required', 'target' => '_blank']) !!}
        @csrf
        @method('post')
        <div class="card">
            <div class="row">
                ...
                success: function(response) {
                    ...
                    if (response.length) {
                        ...
                        $.each(response, function(indexInArray, valueOfElement) {
                            ...
                            selectAvaluation.append('<option value="' + avaliationId + '">' + avaliationName + '</option>');
                        });
                ...
                success: function(response) {
                    ...
                    if (response.metricas.length) {
                        ...
                        $.each(response.metricas, function(indexInArray, valueOfElement) {
                            let avaliationId = valueOfElement.id;
                            let avaliationName = valueOfElement.nome;
                            selectMetric.append('<option value="' + avaliationId + '">' + avaliationName + '</option>');
                        });
