<title>Alunos na segunda chamada</title>
@extends('layouts.generic_index_new')
@section('page-title', 'Lista da segunda chamada')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Lista da segunda chamada</li>
@endsection
@section('selects')
    <div class="mb-2">
...
@section('body')
    <div class="row">
        <div class="col">
            {!! Form::open(['route' => ['s_chamada_pdf'], 'method' => 'post', 'required' => 'required', 'target' => '_blank']) !!}
            @csrf
            @method('post')
            <div class="card">
                <div class="row">
