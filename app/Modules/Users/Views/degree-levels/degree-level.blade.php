@switch($action)
    @case('create') @section('title',__('Users::degree-levels.create_degree_level')) @break
@case('show') @section('title',__('Users::degree-levels.degree_level')) @break
@case('edit') @section('title',__('Users::degree-levels.edit_degree_level')) @break
@endswitch
    ...
    <div class="content-panel">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('Users::degree-levels.create_degree_level') @break
                                @case('show') @lang('Users::degree-levels.degree_level') @break
                                @case('edit') @lang('Users::degree-levels.edit_degree_level') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('degree-levels.create') }} @break
                            @case('show') {{ Breadcrumbs::render('degree-levels.show', $degree_level) }} @break
                            @case('edit') {{ Breadcrumbs::render('degree-levels.edit', $degree_level) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['degree-levels.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($degree_level) !!}
                    @break
                    @case('edit')
                    {!! Form::model($degree_level, ['route' => ['degree-levels.update', $degree_level->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('degree-levels.edit', $degree_level->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
