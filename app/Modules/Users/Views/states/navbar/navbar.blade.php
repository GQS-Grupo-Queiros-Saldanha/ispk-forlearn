...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <div class="col-10">
        ...
        <div class="row">
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>ESTADOS
            </a>
                ...
                @if (auth()->user()->hasAnyRole(['superadmin']))
                    <div class="dropdown ani-d">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 260px;">
                            ...
                            <a class="dropdown-item"  href="/users/states">
                                    <i class="fa fa-cogs"></i> Criar estados</a>
                            <!--<a class="dropdown-item"  href="/users/student_state/create">-->
                            <!--        <i class="fa fa-cogs"></i> Estado do Estudante</a>-->
                            <!--<a class="dropdown-item"  href="/users/schedulingState">-->
                            <!--    <i class="fa fa-cogs"></i> Agendar estados</a>-->
                            <a class="dropdown-item"  href="/users/states-matriculation">
                                    <i class="fa fa-cogs"></i> Estado dos matriculados</a>
                            {{-- <a class="dropdown-item"  href="/users/student_state">
                                    <i class="fa fa-cogs"></i> Gerir estados</a> --}}
