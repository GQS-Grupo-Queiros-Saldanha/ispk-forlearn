<title>Rotações | forLEARN® by GQS</title>
@extends('layouts.generic_index_new')
@section('page-title', 'Rotações')
@section('breadcrumb')
<li class="breadcrumb-item">
    <a href="/">Home</a>
</li>
<li class="breadcrumb-item active" aria-current="page">Rotações</li>
@endsection
    ...
    <script>
        $(function () {
            $('#grau-academico-table').DataTable({
                ajax: '{!! route('rotacao-regime-especial.ajax') !!}',
                buttons:[
                    'colvis',
                        'excel',
                        'pdf',
                {
                            ...
                            action: function(e, dt, node, config) { 
                                let url =  'rotacao-regime-especial/create/';
