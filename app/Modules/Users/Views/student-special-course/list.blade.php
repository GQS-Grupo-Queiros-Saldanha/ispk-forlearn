<title>CURSOS PROFISSIONAIS | forLEARN® by GQS</title>
        ...
        <div class="card">
            ...
            <div class="col-12">
                <div class="float-right">
                    <a href="" class="btn btn-primary" id="btn-submit" target="_blank">
                    @icon('fa fa-file-pdf') 
                    Gerar lista
                    </a>
                </div>  
...
@section('scripts-new')
    ...
    <script>
        ...
        selectEdition.change(function() {
            let selectedId = $(this).val(); // Obtém o valor selecionado
            let url = "{{ route('student-special-course.pdf', '__ID__') }}".replace('__ID__', selectedId);
