...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <a class="navbar-brand navbar-logo inicio-nav" style="margin-left:10px;margin-right:10px;" href="{{route("main.index")}}"><i class="fas fa-home"></i>PAINEL INICIAL
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>UTILIZADORES
            </a>

            <a class="navbar-brand casa-inicio" style="margin: 0%; transform: scale(0,0);"
                href="{{ route('panel_avaliation') }}"><i class="fa fa-home"></i> 
            </a>
            <a class="navbar-brand navbar-logo inicio-nav" target="_blank" href="{{ route('studio-photo.index') }}"><i class="fas fa-image"></i> Estúdio de fotografia</a>
            @if(auth()->user()->hasAnyPermission('acess-control-log'))
            <a class="navbar-brand navbar-logo inicio-nav" target="_blank" href="/controlodeacessos"><i class="fas fa-desktop"></i> Controlo de acessos</a>
            @endif
                ...
                @if (auth()->user()->hasAnyRole(['superadmin']))
                    <div class="dropdown ani-d">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 200px;">
                              <a class="dropdown-item" href="/users/parameters" target="_blank">
                        <i class="fas fa-id-card"></i> Paramêtros dinâmicos </a>
