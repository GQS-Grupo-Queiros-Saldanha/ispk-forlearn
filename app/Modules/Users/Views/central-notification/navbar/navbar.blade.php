<style>
    ...
    * {
    ...
    #searchable-list .nav-item .nav-link p{
...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <div class="col-10">
        ...
        <div class="row">
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>CENTRAL DE NOTIFICAÇÕES
            </a>
                ...
                @if (auth()->user()->hasAnyRole(['superadmin']))
                    <div class="dropdown ani-d">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                            ...
                            <a class="dropdown-item"  href="?central-control=setting">
                                    <i class="fa fa-cogs"></i> Definições</a>
