                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="card">
                                                ...
                                                @if($action !== 'create')
                                                    @include('Users::users.partials.courses')get_validation_bi
                                                @endif
                                                @if ($action !== 'create')
                    ...
                    $.ajax({
                        ...
                        success: function (dataResult) {
                             if (dataResult.status == 2) {
                                ...
                                if ( $("#id_number").val().match(/^[0-9]{9}[A-Z]{2}[0-9]{3}$/) || $("#id_number").val().match(/^[A-Z]{2}[0-9]{6}$/) || $("#id_number").val().match(/^[A-Z][0-9]{6}$/) ) {
