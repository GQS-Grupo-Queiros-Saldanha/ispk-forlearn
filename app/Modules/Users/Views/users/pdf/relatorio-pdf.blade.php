...
<main>
    <title>Tabela dos Estudantes</title>
    <div class="row">
        <div class="col-12">
            <br>
            <center>
            ...
            <h3 class="title-dom">
                <br>
                <br>
                Lista de <br> Estudantes <br><br>
            </h3>
            <h4 class="title-dom10">
                {{ $users->first()->course_name}}
            </h4>
            <br>
            <br>
            <br>
    ...
    <main id="content">
        <div class="table-wrapper">
            ...
            <table id="table-editions" class="article-table">
                ...
                <tbody>
                    @foreach ($users as $index => $user)
                        <tr>
                            ...
                            <td class="">{{ $user->matricula }}</td>
                            <td class="">{{ $user->n_bi }}</td>
                            <td class="">{{ $user->nome_student }}</td>
