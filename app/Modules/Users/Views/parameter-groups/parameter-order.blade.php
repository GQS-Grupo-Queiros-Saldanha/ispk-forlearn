            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <span class="text-muted">Pode reordenar os parâmetros abaixo, arrastando-os.</span>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        {!! Form::open(['route' => ['parameter-groups.save_parameter_order', $parameter_group->id], 'id' => 'form-parameter-groups-order', 'method' => 'put']) !!}
                        ...
                        <div class="card">
                            <div class="card-body">
                                @if(count($parameter_group->parameters) > 0)
                                    <ol class="list-group list-group-sortable" id="items">
                                        @foreach($parameter_group->parameters as $parameter)
                                            <li class="list-group-item" style="cursor: move" data-id="{{ $parameter->id }}">{{ $parameter->currentTranslation->display_name }}</li>
                                        @endforeach
                                    </ol>
                                @else
                                    ...
    ...
    <script>
        ...
        $(function(){
            ...
            $('#form-parameter-groups-order').on('submit', function(e) {
                ...
                var _method = $self.find('input[name=_method]').val();
                var _token = $self.find('input[name=_token]').val();
