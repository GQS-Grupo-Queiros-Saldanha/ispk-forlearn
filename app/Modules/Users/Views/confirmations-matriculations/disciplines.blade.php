@if(!empty($disciplinesReproved) && !empty($curricularPlanDisciplines))
    ...
    @if ($estado['pontos'] < 5 && $estado['curso']=="CEE" && $nextYear==3  || $estado['Obs']=="normal" &&  $estado['curso']!="CEE" 
    ...
    <ul style="list-style: none" class="Lista_disciplina">
            @foreach ($curricularPlanDisciplines as $discipline)
                ...
                @endphp
                <li class="item_list_disciplines_{{ $discipline['discipline_id']}} item_classes_{{ $year }}">
