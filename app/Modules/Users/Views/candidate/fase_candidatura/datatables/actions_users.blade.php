...
<button class="btn btn-sm btn-dark gerar-pdf" title="gerar pdf" data-toggle="modal" data-target="#modal-pdf" onclick="$('#modal-pdf').modal()"  user="{{$item->id}}"
    url="{{$url}}">
    @icon('fas fa-file-pdf')
</button>

<!--@if($negativeInFase && !$existInNextFase && isset($faseNext->fase))-->
...
<script class="script-page">
    ...
    gerarPDF.on('click',function(e){
        ...
        $('#form-modal-pdf').attr('action',obj.attr('url'));
    });
