<title>Alunos na Turma</title>
@extends('layouts.generic_index_new')
@section('page-title', 'Alunos na turma')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Lista por turma</li>
@endsection
@section('selects')
    <div class="mb-2">
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="row">
                    ...
                    {{-- <div class="col-6">
                        <div class="form-group col">
                            <label>Listar estudantes devedores?</label>
                            <select required
