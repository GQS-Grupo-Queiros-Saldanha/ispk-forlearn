@section('title',__('Pedido de transferência'))
    ...
    @include('Avaliations::requerimento.navbar.navbar')
        <div class="content-header">
            <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <div class=" float-right" > 
                            <ol class="breadcrumb float-rigth" style="padding-top: 4px; padding-bottom: 0px;">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Pedido de transferência</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@lang('Pedido de transferência')</h1>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group col">
                                            <label>Tipo de pedido de transferência</label>
                                            <select name="tipe_transference" id="tipe_transference" required class="selectpicker form-control form-control-sm" data-live-search="true" data-actions-box="false" data-selected-text-format="values" tabindex="-98">
                                                <option value="1">Entrada no ({{$institution}})</option>
                                                <option value="2">Saída no ({{$institution}})</option>
                                                </select>
                                        </div>
