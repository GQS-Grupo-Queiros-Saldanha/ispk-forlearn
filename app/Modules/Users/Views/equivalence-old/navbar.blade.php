...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <a class="navbar-brand navbar-logo inicio-nav" style="margin-left:10px;margin-right:10px;" href="{{route("main.index")}}"><i class="fas fa-home"></i>PAINEL INICIAL
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>EQUIVALÊNCIA
            </a>
            ...
            @if (auth()->user()->hasAnyRole(['teacher', 'coordenador_curso', 'coordenador', 'superadmin']))
                <div class="dropdown ani-d">
                    <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                        ...
                        <i class="fa fa-pencil-square-o"></i>Estudantes
                    </li>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 400px;">
                        {{-- @if (auth()->user()->hasAnyRole(['teacher', 'coordenador_curso', 'coordenador', 'superadmin'])) --}}
                        <a class="dropdown-item" target="_blank" href="/users/student-change">
                        ...
                        <a class="dropdown-item" target="_blank" href="/users/avaliations-equivalence">
                            <i class="fa fa-pencil-square-o"></i>
                            Notas por equivalência</a>

                        <a class="dropdown-item" href="{{ route('matriculation-students.list-change') }}"><i
                            class="fas fa-list-alt"></i>Mudança por bloqueio de ano curricular </a>
            ...
            @if (auth()->user()->hasAnyRole(['superadmin']))
                {{-- <div class="dropdown ani-d">
                    <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                        ...
                        <i class="fa fa-bar-chart"></i> Transferência 
                    </li>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                        ...
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            ...
                            <i class="fa fa-bar-chart"></i> Interna</a>

                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/estatistica-geral-percurso">
                            <i class="fa fa-bar-chart"></i> Externa</a>
                ...
                @if (auth()->user()->hasAnyRole(['superadmin']))
                    <div class="dropdown ani-d">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 260px;">
                            ...
                            <a class="dropdown-item" target="_blank" href="/users/change-course-setting">
                                <i class="fa fa-cogs"></i> Mudança de curso</a>
