@section('title',__('RH - criar situação profissional'))
                ...
                <div class="associarCodigo">
                    <div class="ml-0 mr-0 pl-0 pr-0  pb-4 row col-12 ">
                        ...
                        <h5 class="col-md-12 mb-3 text-right text-muted text-uppercase">
                            @switch($action)
                                @case('create') @lang('Users::professional-states.create_professional_state') @break
                                @case('show') @lang('Users::professional-states.professional_state') @break
                                @case('edit') @lang('Users::professional-states.edit_professional_state') @break
                            @endswitch
                        </h5>
                        ...
                        <div class="container-fluid">
                            ...
                            @switch($action)
                                @case('create')
                                {!! Form::open(['route' => ['professional-states.store']]) !!}
                                @break
                                @case('show')
                                {!! Form::model($professional_state) !!}
                                @break
                                @case('edit')
                                {!! Form::model($professional_state, ['route' => ['professional-states.update', $professional_state->id], 'method' => 'put']) !!}
                                @break
                            @endswitch
                                ...
                                <div class="col" style="background-color: #f5fcff">
                                    ...
                                    @if ($errors->any())
                                        <div class="alert alert-danger alert-dismissible">
                                            ...
                                            <h5>@choice('backoffice', $errors->count())</h5>
                                            <ul>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    @switch($action)
                                        ...
                                        @break
                                        @case('show')
                                        <a href="{{ route('professional-states.edit', $professional_state->id) }}" class="btn  btn-warning mb-3">
                                            @icon('fas fa-edit')
                                            @lang('common.edit')
                                        </a>
                                        @break
