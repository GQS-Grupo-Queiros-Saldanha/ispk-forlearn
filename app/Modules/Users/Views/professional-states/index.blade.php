@section('title',__('RH - situações profissionais'))
                ...
                <div class="associarCodigo">
                    <div class="ml-0 mr-0 pl-0 pr-0  pb-4 row col-12 ">
                        ...
                        <h5 class="col-md-12 mb-3 text-right text-muted text-uppercase">
                            @lang('Users::professional-states.professional_states')
                        </h5>
                        ...
                        {{-- <div class="col-12"> --}}
                            <div class="col" style="background-color: #f5fcff">
                                ...
                                <a href="{{ route('professional-states.create') }}" class="btn btn-primary  mb-3">
                                    @icon('fas fa-plus-square')
                                    @lang('common.new')
                                </a>

                                <table id="professional-states-table" class="table table-striped table-hover">
                                    <thead>
                                    <tr>
...
@parent
    ...
    <script>
        $(function () {
            $('#professional-states-table').DataTable({
                ajax: '{!! route('professional-states.ajax') !!}',
                columns: [{
                    data: 'code',
                    name: 'code',
                    visible: false
