                ...
                <div class="associarCodigo">
                    <div class="ml-0 mr-0 pl-0 pr-0  pb-4 row col-12 ">
                        ...
                        <h5 class="col-md-12 mb-3 text-right text-muted text-uppercase">
                            @switch($action)
                                @case('create') @lang('Users::professions.create_profession') @break
                                @case('show') @lang('Users::professions.profession') @break
                                @case('edit') @lang('Users::professions.edit_profession') @break
                            @endswitch
                        </h5>
                        ...
                        <div class="container-fluid">
                            ...
                            @switch($action)
                                ...
                                @break
                                @case('show')
                                {!! Form::model($profession) !!}
                                @break
                                @case('edit')
                                {!! Form::model($profession, ['route' => ['professions.update', $profession->id], 'method' => 'put']) !!}
                                @break
                            @endswitch
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    @switch($action)
                                        ...
                                        @break
                                        @case('show')
                                        <a href="{{ route('professions.edit', $profession->id) }}" class="btn btn-sm btn-warning mb-3">
                                            @icon('fas fa-edit')
                                            @lang('common.edit')
                                        </a>
                                        @break
