         ...
         $yearsWithClasses = [];
          ...
          else
          {
            ...
            if ($get_matriculation_class_total + 1 <= $get_class_vacancies) {
                ...
                Log::info('Emolumentos a serem processados', [
                    'emolumento_confirmacao' => $emolumento[$index],
                    'emolumento_folha_de_prova' => $emolumentoFolha,
                    'emolumento_folha_de_prova2' => $emolumentoFolha2
                ]);
