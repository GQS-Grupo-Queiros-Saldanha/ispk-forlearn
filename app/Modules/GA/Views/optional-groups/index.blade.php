@section('title',__('GA::optional-groups.optional_groups'))
    ...
    @include("GA::navbar.navbar")
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('GA::optional-groups.optional_groups')</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('optional-groups.create') }}" class="btn btn-success btn-sm mb-3">
    ...
    <script>
        $(function () {
            $('#optional-groups-table').DataTable({
                ajax: '{!! route('optional-groups.ajax') !!}',
                buttons:[
                    'colvis',
                    'excel'
                ],
