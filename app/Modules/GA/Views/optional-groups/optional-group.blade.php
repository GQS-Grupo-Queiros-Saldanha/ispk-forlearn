@switch($action)
    @case('create') @section('title',__('GA::optional-groups.create_optional_group')) @break
@case('show') @section('title',__('GA::optional-groups.optional_group')) @break
@case('edit') @section('title',__('GA::optional-groups.edit_optional_group')) @break
@endswitch
    ...
    @include("GA::navbar.navbar")
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::optional-groups.create_optional_group') @break
                                @case('show') @lang('GA::optional-groups.optional_group') @break
                                @case('edit') @lang('GA::optional-groups.edit_optional_group') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('optional-groups.create') }} @break
                            @case('show') {{ Breadcrumbs::render('optional-groups.show', $optional_group) }} @break
                            @case('edit') {{ Breadcrumbs::render('optional-groups.edit', $optional_group) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['optional-groups.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($optional_group) !!}
                    @break
                    @case('edit')
                    {!! Form::model($optional_group, ['route' => ['optional-groups.update', $optional_group->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('optional-groups.edit', $optional_group->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
