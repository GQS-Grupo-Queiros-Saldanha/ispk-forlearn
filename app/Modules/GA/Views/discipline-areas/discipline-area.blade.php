@switch($action)
    @case('create') @section('title',__('GA::discipline-areas.create_discipline_area')) @break
@case('show') @section('title',__('GA::discipline-areas.discipline_area')) @break
@case('edit') @section('title',__('GA::discipline-areas.edit_discipline_area')) @break
@endswitch
    ...
    @include("GA::navbar.navbar")
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::discipline-areas.create_discipline_area') @break
                                @case('show') @lang('GA::discipline-areas.discipline_area') @break
                                @case('edit') @lang('GA::discipline-areas.edit_discipline_area') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('discipline-areas.create') }} @break
                            @case('show') {{ Breadcrumbs::render('discipline-areas.show', $discipline_area) }} @break
                            @case('edit') {{ Breadcrumbs::render('discipline-areas.edit', $discipline_area) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['discipline-areas.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($discipline_area) !!}
                    @break
                    @case('edit')
                    {!! Form::model($discipline_area, ['route' => ['discipline-areas.update', $discipline_area->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('discipline-areas.edit', $discipline_area->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
