@switch($action)
    @case('create') @section('title',__('GA::period-types.create_period_type')) @break
@case('show') @section('title',__('GA::period-types.period_type')) @break
@case('edit') @section('title',__('GA::period-types.edit_period_type')) @break
@endswitch
    ...
    <div class="content-panel" style="padding: 0px">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::period-types.create_period_type') @break
                                @case('show') @lang('GA::period-types.period_type') @break
                                @case('edit') @lang('GA::period-types.edit_period_type') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('period-types.create') }} @break
                            @case('show') {{ Breadcrumbs::render('period-types.show', $period_type) }} @break
                            @case('edit') {{ Breadcrumbs::render('period-types.edit', $period_type) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['period-types.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($period_type) !!}
                    @break
                    @case('edit')
                    {!! Form::model($period_type, ['route' => ['period-types.update', $period_type->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('period-types.edit', $period_type->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @include('GA::period-types.partials.discipline-periods')
                            </div>
                        </div>
