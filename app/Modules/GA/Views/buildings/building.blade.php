@switch($action)
    @case('create') @section('title',__('GA::buildings.create_building')) @break
    @case('show') @section('title',__('GA::buildings.building')) @break
    @case('edit') @section('title',__('GA::buildings.edit_building')) @break
@endswitch
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::buildings.create_building') @break
                                @case('show') @lang('GA::buildings.building') @break
                                @case('edit') @lang('GA::buildings.edit_building') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('buildings.create') }} @break
                            @case('show') {{ Breadcrumbs::render('buildings.show', $building) }} @break
                            @case('edit') {{ Breadcrumbs::render('buildings.edit', $building) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('buildings.edit', $building->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
