@switch($action)
    @case('create') @section('title',__('GA::duration-types.create_duration_type')) @break
@case('show') @section('title',__('GA::duration-types.duration_type')) @break
@case('edit') @section('title',__('GA::duration-types.edit_duration_type')) @break
@endswitch
    ...
    <div class="content-panel" style="padding: 0px">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::duration-types.create_duration_type') @break
                                @case('show') @lang('GA::duration-types.duration_type') @break
                                @case('edit') @lang('GA::duration-types.edit_duration_type') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('duration-types.create') }} @break
                            @case('show') {{ Breadcrumbs::render('duration-types.show', $duration_type) }} @break
                            @case('edit') {{ Breadcrumbs::render('duration-types.edit', $duration_type) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['duration-types.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($duration_type) !!}
                    @break
                    @case('edit')
                    {!! Form::model($duration_type, ['route' => ['duration-types.update', $duration_type->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('duration-types.edit', $duration_type->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
