@section('title',__('GA::event-types.event_types'))
    ...
    @include('GA::events.navbar.navbar')
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tipos de eventos</h1>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('event-types.create') }}" class="btn btn-success btn-sm mb-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="event_types-table" class="table table-striped table-hover">
                                    <thead>
                                    <tr>
...
@section('scripts')
    ...
    <script>
        $(function () {
            $('#event_types-table').DataTable({
                ajax: '{!! route('event-types.ajax') !!}',
                buttons:[
                    'colvis',
                    'excel'
                ],
