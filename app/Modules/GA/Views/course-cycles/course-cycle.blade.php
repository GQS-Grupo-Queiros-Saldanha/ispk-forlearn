@switch($action)
    @case('create') @section('title',__('GA::course-cycles.create_course_cycle')) @break
@case('show') @section('title',__('GA::course-cycles.course_cycle')) @break
@case('edit') @section('title',__('GA::course-cycles.edit_course_cycle')) @break
@endswitch
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::course-cycles.create_course_cycle') @break
                                @case('show') @lang('GA::course-cycles.course_cycle') @break
                                @case('edit') @lang('GA::course-cycles.edit_course_cycle') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('course-cycles.create') }} @break
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('course-cycles.edit', $course_cycle->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
