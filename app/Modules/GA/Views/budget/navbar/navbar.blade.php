...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <div class="col-10">
        ...
        <div class="row">
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>ORÇAMENTOS
            </a>
            ...
            <div class="col-6">
                    ...
                    <div class="dropdown ani-d">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 200px;">
                            <a class="dropdown-item" href="/gestao-academica/budget_type">
                                <i class="fa-solid fa-calendar-days"></i>Tipos de orçamentos</a>
