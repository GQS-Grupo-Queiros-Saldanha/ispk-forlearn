        ...
        <div class="div-top">
           <div class="divTable">
            ...
            <div class="divTableCell pl-1">
                <h1 class="h1-title" style="padding-left:35px;">
                    HORÁRIO DO ALUNO
                </h1>
            </div>
                                ...
                                <table class="table table-parameter-group" border="2">
                                    <thead  class="thead-parameter-group">
                                        <tr>
                                            ...
                                            <th class="th-parameter-group" style="font-size:10pt;">Curso</th>
                                    ...
                                    <tbody>
                                        <tr>
                                        <td>{{$personal['name']}}  #{{$personal['n_mecanografico']}}  ({{$user->email}})</td>
                                            <td> 
