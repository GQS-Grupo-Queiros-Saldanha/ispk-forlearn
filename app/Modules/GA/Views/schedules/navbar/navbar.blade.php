...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark col-12" style="margin:0px!important;padding:0!important!">    
    ...
    <a class="navbar-brand navbar-logo inicio-nav tirar" href="#">
        <i class="fas fa-bookmark"></i>HORÁRIOS
    </a>
    ...
    <div class="collapse navbar-collapse dropdown ani-d" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown li-nav">
                <li class="nav-link dropdown-toggle a-first" id="navbarDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa-solid fa-person-chalkboard"></i>Horários 
                </li>
                
               
                        
                @if (auth()->user()->hasAnyRole(['superadmin', 'teacher', 'coordenador-curso']) || auth()->user()->hasAnyRole(['auxiliar-administrativo']))
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('schedules.create') }}"><i
                                class="fa-solid fa-person-chalkboard"></i>Novo</a>
    
                    </div>
                @endif
            </li>
            @endif
            @if (auth()->user()->hasAnyRole(['superadmin', 'teacher', 'coordenador-curso']))
                <li class="nav-item li-nav">
                    <a class="nav-link a-first a-second" style="width: 130px;" href="/gestao-academica/schedule_teacher">
                        <i class="fas"></i> Professor 
                    </a>
                </li>
            @endif

            @if (auth()->user()->hasAnyRole(['superadmin', 'student'])) 
                <li class="nav-item li-nav">
                    <a class="nav-link a-first a-second" style="width: 130px;" href="/gestao-academica/schedule_student/6">
                        <i class="fas"></i> Estudante
                    </a>
                </li>
            @endif
            ...
            {{-- @if (auth()->user()->hasAnyPermission(['manage-summaries', 'superadmin'])) --}}
                {{-- <li class="nav-item li-nav">
                    <a class="nav-link a-first a-second" style="width: 180px;" href="/gestao-academica/schedule-types">
                        <i class="fas"></i> Tipo de Horários 
                    </a>
                </li> --}}
            {{-- @endif --}}
        ...
        <div class="row">
            ...
            <div class="col-6">
                @if (auth()->user()->hasAnyRole(['superadmin']))
                    <div class="dropdown ani-d" style="padding-top: 12px">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 260px;">
                            ...
                            <a class="dropdown-item" target="_blank" href="/gestao-academica/schedule-types">
                                <i class="fa fa-cogs"></i> Tipo de Horários 
                            </a>
