...
<main>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <b class="title-dom2">
        ...
        <span class="text-row text-span text-color">{{ $lectiveYears[0]->currentTranslation->display_name }}</span>
      </b>
    </div>
  </div>
  <br>
  ...
  <div class="row">
    <div class="col-md-12">
      @foreach ($model as $courseName => $classes)
      @if (!$loop->first)
    ...
    @endif
      ...
      <thead>
        <tr>
        <th class="header-title" colspan="10">{{ $courseName }}</th> <!-- Nome do Curso -->
        </tr>
        <tr>
      ...
      <td class="text-center">{{ $class->display_name }}</td>
      <td class="text-center">{{ ucfirst($class->schedule) }}</td>
      <td class="text-center">{{ $class->year }}</td>
      <td class="text-center">{{ $class->room }}</td>
      <td class="text-center">{{ $class->vacancies }}</td>
      </tr>
    @endforeach
      </tbody>
      </table>
