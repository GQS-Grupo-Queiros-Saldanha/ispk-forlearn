...
<main>
    <title>Entidades bolseira / protocolos</title>
    <div class="row">
        <div class="col-12">
            <br>
            <center>
            ...
            <h3 class="title-dom"> <br>
                <br>
                Entidades <p>Bolseiras / Protocolo</p>
            <br>
            <br>
            <br>
            <!-- <br>
            <b class="title-dom2">
                <b class="text-row">Ano lectivo</b>
                <span
                    class="text-row text-span text-color">{{ $lectiveYears[0]->currentTranslation->display_name }}</span>
            </b> -->
        </div>
    </div>
    <br>
...
echo date('d') . ' de ' . $mes[$m] . ' de ' . date('Y');
    ...
    <main id="content">
        <div class="table-wrapper">
            ...
            <table id="table-rooms" class="article-table">
                <thead>
                    <tr>
                        <th class="header-title" colspan="10">Tabela de Entidades</th>
                    </tr>
                    <thead>
                        <tr>
                ...
                <tbody>
                    @foreach ($entidades as $index => $entidade)
                        <tr>
                            ...
                            <td>{{ $entidade->registered_office }}</td>
                            <td>{{ $entidade->NIF }}</td>
                            <td>{{ $entidade->telf}}</td>
                            <td>{{ $entidade->phone_person }}</td>
                        </tr>
                    @endforeach
                </tbody>
