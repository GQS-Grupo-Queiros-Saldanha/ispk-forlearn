@section('title',__('GA::rooms.rooms'))
    ...
    <div class="content-panel" style="padding: 0px">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('GA::rooms.rooms')</h1>
                        <span class="text-muted">Sala A1, Sala B1...</span>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('rooms.create') }}" class="btn btn-success btn-sm mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <table id="rooms-table" class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('GA::buildings.building')</th>
