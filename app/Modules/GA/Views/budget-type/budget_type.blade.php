    ...
    <div class="content-panel" style="padding:0">
                    ...
                    <div class="col-sm-12">
                        <div class=" float-right">
                            <ol class="breadcrumb float-rigth" style="padding-top: 4px; padding-bottom: 0px;">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('budget_type.index') }}">Tipos de orçamentos</a></li>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                        {!! Form::open(['route' => ['budget_type.store']]) !!}
                    @break

                    @case('show')
                        {!! Form::open(['route' => ['budget_type.update', $budget_type->id]]) !!}
                    @break
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-6">
                                        {{ Form::bsCustom('name', $budget_type->name ?? null, ['type' => 'text', 'placeholder' => '', 'disabled' => $action === 'show', 'required' => true], ['label' => 'Nome']) }}
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-8">
                                        ...
                                        disabled @endif required>{{ $budget_type->description ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group  col">
                                        ...
                                        @switch($action)
                                            ...
                                            @case('show')
                                                <a href="{{ route('budget_type.edit', $budget_type->id) }}"
