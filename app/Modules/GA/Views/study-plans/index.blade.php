    ...
    <div class="content-panel" style="padding: 0px">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('study-plans.create') }}" class="btn btn-success btn-sm mb-3">
                            @icon('fas fa-plus-square')
                            @lang('common.new')
                        </a>
                        <div class="card">
                            <div class="card-body">
                                <table id="study-plans-table" class="table table-striped table-hover">
                                    <thead>
                                    <tr>
...
@section('scripts')
    ...
    <script>
        $(function () {
            $('#study-plans-table').DataTable({
                ajax: '{!! route('study-plans.ajax') !!}',
                buttons:[
                    'colvis',
                    'excel'
                ],
