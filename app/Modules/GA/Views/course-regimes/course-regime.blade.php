@switch($action)
    @case('create') @section('title',__('GA::course-regimes.create_course_regime')) @break
@case('show') @section('title',__('GA::course-regimes.course_regime')) @break
@case('edit') @section('title',__('GA::course-regimes.edit_course_regime')) @break
@endswitch
    ...
    <div class="content-panel" style="padding: 0px">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            @switch($action)
                                @case('create') @lang('GA::course-regimes.create_course_regime') @break
                                @case('show') @lang('GA::course-regimes.course_regime') @break
                                @case('edit') @lang('GA::course-regimes.edit_course_regime') @break
                            @endswitch
                        </h1>
                    </div>
                    <div class="col-sm-6">
                        @switch($action)
                            @case('create') {{ Breadcrumbs::render('course-regimes.create') }} @break
                            @case('show') {{ Breadcrumbs::render('course-regimes.show', $course_regime) }} @break
                            @case('edit') {{ Breadcrumbs::render('course-regimes.edit', $course_regime) }} @break
                        @endswitch
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @switch($action)
                    @case('create')
                    {!! Form::open(['route' => ['course-regimes.store']]) !!}
                    @break
                    @case('show')
                    {!! Form::model($course_regime) !!}
                    @break
                    @case('edit')
                    {!! Form::model($course_regime, ['route' => ['course-regimes.update', $course_regime->id], 'method' => 'put']) !!}
                    @break
                @endswitch
                ...
                <div class="row">
                    <div class="col">
                        ...
                        @switch($action)
                            ...
                            @break
                            @case('show')
                            <a href="{{ route('course-regimes.edit', $course_regime->id) }}" class="btn btn-sm btn-warning mb-3">
                                @icon('fas fa-edit')
                                @lang('common.edit')
                            </a>
                            @break
