...
class DisciplineRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'code' => 'required|max:191|unique:disciplines,code,' . $this->route('discipline'),
            'discipline_areas' => 'required|exists:discipline_areas,id',
            'profile' => 'required|exists:discipline_profiles,id',
            'course' => 'numeric|exists:courses,id',
            'maximum_absence' => 'numeric',
            'percentagem' => []
        ];
