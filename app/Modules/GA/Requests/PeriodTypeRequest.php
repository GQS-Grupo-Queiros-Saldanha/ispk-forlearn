...
class PeriodTypeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $rules = [
            'code' => 'required|max:191|unique:period_types,code,' . $this->route('period_type'),
            'period' => 'required|exists:discipline_periods,id',
        ];
