        ...
        <div class="row">
            ...
            @if (auth()->user()->hasRole(['student']) )
                <div class="dropdown ani-d">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                        <a class="dropdown-item" target="_blank" href="/avaliations/discipline_boletimNotas"><i
                            class="fa fa-eye"></i> Boletim de notas</a>
                    </div>
                </div>
            ...
            @else              
                ...
                <div class="dropdown ani-d">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 240px;">
                        ...
                        <a class="dropdown-item" target="_blank" href="/avaliations/other_avaliations">
                            <i class="fa fa-pencil-square-o"></i>
                            OA's</a>
                        {{--<a class="dropdown-item fa-solid fa-arrow-right" style="padding-bottom: 5%" target="_blank" href="/avaliations/old_student_final_grade">
                             Atribuir Notas TFC</a> 
                        --}}
                        <hr class="m-0">                    
                    
                        @if (auth()->user()->hasAnyRole(['superadmin','coordenador-curso']) )
                            <a class="dropdown-item" target="_blank" href="/grades/teacher">
                                <i class="fa fa-pencil-square-o"></i>
                                Notas de exame de acesso</a>
                            <hr class="m-0">
                        @endif 
                        @if (auth()->user()->hasAnyPermission(['av_notas_efetuar_transicao_notas']) )
                        <a class="dropdown-item" target="_blank" href="/avaliations/old_student">
                            <i class="fa fa-pencil-square-o"></i>
                            Notas por transição
                        </a>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['gerir_equivalência']))
                            <a class="dropdown-item" target="_blank" href="/users/avaliations-equivalence">
                                <i class="fa fa-pencil-square-o"></i>
                                Notas por equivalência
                            </a>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['av_notas_efetuar_transicao_notas']) )
                            <a class="dropdown-item" target="_blank" href="{{ route('avaliacao.finalista') }}">
                                <i class="fa fa-pencil-square-o"></i>
                                Nota dos Finalistas fora de epoca</a>
                        @endif
                    </div>
                ...
                <div class="dropdown ani-d">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                        ...
                        <a class="dropdown-item" href="/avaliations/discipline_grades_seminario/1">
                                    <i class="fa fa-eye"></i> TESP
                        </a>
            ...
            @if (auth()->user()->hasAnyRole(['coordenador-curso', 'superadmin']))
                <div class="dropdown ani-d">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="/avaliations/discipline_grades_seminario/15">
                            <i class="fa fa-play"></i> TESP
                        </a>
            ...
            <div class="dropdown ani-d">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                    ...
                    @if (auth()->user()->hasAnyPermission(['teacher_matriculation']))
                        <a class="dropdown-item" target="_blank" href="/avaliations/matriculations_student">
                        <i class="fa fa-search"></i>Lista de matriculados </a>
                    ...
                    @endif
                    @if (auth()->user()->hasAnyPermission(['av_gerir_percurso_academico_error']))
                        <a class="dropdown-item" target="_blank" href="/avaliations/percurso_task">
                        <i class="fa fa-search"></i>Erro no PA </a>
                     @endif
            ...
            <div class="dropdown ani-d">
                @if (auth()->user()->hasAnyPermission(['gerir_requerimento']))
                    <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        style=" text-align: left!important;">
            ...
            {{-- REQUERER --}}
            @if(auth()->user()->hasAnyRole(['coordenador-curso','superadmin','Chefe_do_gabinete_de_termos','staff_gabinete_termos','av_gerir_percurso_academico']))
                <div class="dropdown ani-d">
                    <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        style=" text-align: left!important;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                        ...
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/estatistica-candidato">
                            <i class="fa fa-bar-chart"></i> Relatórios candidatos</a>
                            
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/avaliacao-estatistica">
                            <i class="fa fa-bar-chart"></i> Relatórios estatístico</a>  
                            
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/estatistica-geral-percurso">
                            <i class="fa fa-bar-chart"></i> Relatórios geral</a> 
                            
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/estatistica-graduado">
                            <i class="fa fa-bar-chart"></i> Relatórios dos graduados</a>
                        
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/avaliations/estatistica-anual">
                            <i class="fa fa-bar-chart"></i> Relatórios anual</a>
    ...
    <div class="col-2">
        ...
        <div class="row">
            <div class="col-6">
                ...
                @if (auth()->user()->hasAnyRole(['superadmin']) || auth()->user()->hasAnyPermission(['configuracao_avaliacao']))
                    <div class="dropdown ani-d">
                        <li class=" dropdown-toggle text-white d-menu" type="button" id="dropdownMenuButton"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 260px;">
                            ...
                            <a class="dropdown-item" target="_blank" href="{{ route('calendario_prova_horario.index') }}">
                                    <i class="fa fa-cogs"></i> Marcação prova</a>
                            ...
                            @if(auth()->user()->hasAnyRole(['superadmin']))
                                <a class="dropdown-item" target="_blank" href="/avaliations/plano_estudo_avaliacao">
                                    ...
                                    Plano de estudos e avaliação</a>
                            @endif                                
