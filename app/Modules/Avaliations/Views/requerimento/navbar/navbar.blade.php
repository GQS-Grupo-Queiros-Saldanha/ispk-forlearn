...
<nav class="navbar navbar-expand-lg navbar-mainbg col-12" style="margin:0px!important;padding:0!important">
    ...
    <div class="col-10">
        ...
        <div class="row">
            ...
            <a class="navbar-brand navbar-logo inicio-nav tirar" href="#"><i class="fas fa-bookmark"></i>REQUERIMENTOS
            </a>
            ...
            <div class="dropdown ani-d">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width: 250px;">
                        <a class="dropdown-item  element" style="cursor: pointer;" target="_blank"
                           href="{{ route('requerimento_doc') }}" ><i class="fa fa-file-text"></i> Documentos </a>
                        <a class="dropdown-item  element" style="cursor: pointer;" target="_blank"
                            href="{{ route('requerimento_merito') }}"><i class="fa fa-file-text"></i> Certificado de Mérito</a>
                      {{-- REQUERER --}}
                      <a class="dropdown-item  element" style="cursor: pointer;" target="_blank"
                            href="{{ route('requerimento_cerimonia') }}"><i class="fa fa-file-text"></i> Cerimônia de outorga</a>
                        ...
                        <a class="dropdown-item  element" style="cursor: pointer;" target="_blank"
                            href="{{ route('mudanca_turma') }}"><i class="fa fa-file-text"></i> Mudança de turma</a>    
                     @if (auth()->user()->hasAnyPermission(['gerir_equivalência']))   
                        <a class="dropdown-item id_studentPercursoAcademico element" target="_blank"
                            href="/users/transference-request"><i class="fa fa-file-text"></i> Pedido de transferência </a>
                        @endif
