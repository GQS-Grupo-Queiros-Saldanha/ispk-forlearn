...
@section('body')
               {!! Form::open(['route' => ['student_requerimento_store']]) !!}
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="card">
                                ...
                                <input type="hidden" id="codev"  value="{{$codev}}" name="codev">
    ...
    <script>
     ...
     $("#lective_year").change(function(){
        ...
        console.log($("#courses").val());
         $.ajax({
                    url: "/avaliations/requerimento/getFinalists/" + course_id +"/"+lective_year_matriculation + "?type=all",
                    type: "GET",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
