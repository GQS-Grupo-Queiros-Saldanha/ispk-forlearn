    ...
    <script>
        $(document).ready(function (){
           ...
           $('#course_id').change(function(){
            ...
            url: "/avaliations/disciplines_ajax_uc/" + course_id,
            type: "GET",
            data: {
                _token: '{{ csrf_token() }}'
            },
            ...
            success: function (dataResult) {
                ...
                $("#discipline_id").empty();
                var disciplines = dataResult.disciplines;
                var classes = dataResult.classes;
                var bodyData = '';
                var bodyClassData = '';
                var i = 1;
                console.log(dataResult.disciplines);
        ...
        //Buscar Avaliações apartir do curso e disciplina associados ao Plano estudo Avaliacao
           $('#discipline_id').change(function(){
            ...
            url: "/avaliations/avaliacao_ajax_uc/" + discipline_id,
            type: "GET",
            data: {
                _token: '{{ csrf_token() }}'
            },
