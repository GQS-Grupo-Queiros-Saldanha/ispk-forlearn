...
@section('page-title', 'PUBLICAR EXAME ORAL')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Publicar Exame Oral</li>
@endsection
@section('styles-new')
    @parent
    ...
    <script>
        $(document).ready(function() {
            ...
            function getStudentNotasPautaFinal() {
                ...
                $.ajax({
                    url: "/avaliations/getStudentMatriculation/" + id_anoLectivo.val() + "/" + id_curso[0] + "/" + Turma_id_Select.val() + "/" + id_disciplinaVetor[0] + "/" + 5+"/"+25,
                    type: "GET",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    ...
                    if (resultados_student.length != 0) {
                        ...
                        tabelatr += "<th colspan='2'>CLASSIFICAÇÃO DO EXAME ORAL</th>"
                    ...
                    $("#pauta_code").val(25);
                    $("#tipo_pauta").val("Pauta Exame Oral");
