...
@section('page-title', 'PUBLICAR EXAME EXTRAORDINÁRIO')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Publicar exame extraordinário</li>
@endsection
@section('styles-new')
    @parent
            ...
            function getStudentNotasPautaFinal() {
                ...
                $.ajax({
                    ...
                    if (resultados_student.length != 0) {
                        ...
                        tabelatr += "<th  colspan='2'>CLASSIFICAÇÃO EXAME EXTRAORDINÁRIO</th>"
                    ...
                    $("#pauta_code").val(45);
                    $("#tipo_pauta").val("Pauta Exame Extraordinário");
                        ...
                        $.each(item, function(index_exam, item_exam) {
                            if (aluno_nome != index) {
                                ...
                                $.each(item, function(index_avaliacao, item_avaliacao) {
                                    ...
                                    if (item_avaliacao.MT_CodeDV === "Extraordinario") {
                                        if (neen_nome != item_avaliacao.MT_CodeDV) {
                                            if (item_avaliacao.nota_anluno === null) {
                                               
                                                neen = -1;
                                                neen_nome = "Exame_extraordinario";
                                            } else {
