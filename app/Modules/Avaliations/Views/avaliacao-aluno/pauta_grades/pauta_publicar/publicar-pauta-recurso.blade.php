...
@section('page-title', 'PUBLICAR RECURSO')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Publicar recurso</li>
@endsection
@section('styles-new')
    @parent
    ...
    <script>
        $(document).ready(function() {
            ...
            function getStudentNotasPautaFinal() {
                ...
                $.ajax({
                    url: "/avaliations/getStudentGradesRecurso/" + id_anoLectivo.val() + "/" + id_curso[0] + "/" + Turma_id_Select.val() + "/" + id_disciplinaVetor[0] + "/" + 6,
                    type: "GET",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    ...
                    // Mostra os botões
                    if (data['data']['estado_pauta'] == 1 && data['data']['estado_tipo'] == 10 && whoIs != 'teacher') {
                    ...
                    } else if (data['data']['estado_pauta'] == 0 && data['data']['estado_tipo'] == 10 && whoIs != 'teacher' ) {
                        $("#togglee").text("");
                    ...
                    else if(data['data']['estado_pauta']==1 && data['data']['estado_tipo'] == 10 && whoIs == 'teacher'){
                        hide_button = true;
                    }
                    else if(data['data']['estado_pauta']==0 && data['data']['estado_tipo'] == 10 && whoIs == 'teacher'){
                        hide_button = true;
                        ...
                        $.each(item, function(index_exam, item_exam) {
                            if (aluno_nome != index) {
                                ...
                                $.each(item, function(index_avaliacao, item_avaliacao) {
                                    ...
                                    if (item_avaliacao.MT_CodeDV === "Recurso") {
                                ...
                                if (exame_pauta >= data['data']['avaliacao_config'].exame_nota) {
                                    ...
                                    lista_alunos_notas.push([
                                        item_exam.id_mat, item_exam.user_id, exame_pauta, item_exam.sexo, "@"
                                    ])
                                    if (item_exam.sexo == "Feminino") {
