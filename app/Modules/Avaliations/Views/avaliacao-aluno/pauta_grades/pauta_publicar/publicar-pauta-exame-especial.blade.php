...
@section('page-title', 'PUBLICAR EXAME ESPECIAL')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Publicar exame especial</li>
@endsection
@section('styles-new')
    @parent
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div style="margin-top:10px; !important" id="confirmMessage">
                        ...
                        <p>
                            No caso de <span class="text-danger"><b>NÃO HAVER</b></span> nenhuma situação acima, por
    ...
    <script>
        $(document).ready(function() {
            ...
            function getStudentNotasPautaFinal() {
                ...
                $.ajax({
                    url: "/avaliations/getStudentGradesExameEspecial/" + id_anoLectivo.val() + "/" + id_curso[0] + "/" + Turma_id_Select.val() + "/" + id_disciplinaVetor[0] + "/" + 10,
                    type: "GET",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    ...
                    } else if (data['data']['estado_pauta'] == 0 && data['data']['estado_tipo'] == 35) {
                        $("#togglee").text("");
                    ...
                    else if(data['data']['estado_pauta']==1 && data['data']['estado_tipo'] == 35 && data['data']['whoIs'] == 'teacher'){
                        hide_button = true;
                    }
                    else if(data['data']['estado_pauta']==0 && data['data']['estado_tipo'] == 35 && data['data']['whoIs'] == 'teacher'){
                        hide_button = true;
                    }
                    else {
                        $("#acaoID").text("Publicar");
                    ...
                    $("#pauta_code").val(35);
                    $("#tipo_pauta").val("Pauta Exame Especial");
                            ...
                            if (aluno_nome != index) {
                              ...
                              if(hide_button)
                                ...
                                $.each(item, function(index_avaliacao, item_avaliacao) {
                                    ...
                                    if (item_avaliacao.MT_CodeDV === "Exame_especial") {
                                ...
                                if (exame_pauta >= data['data']['avaliacao_config'].exame_nota) {
                                    ...
                                    lista_alunos_notas.push([item_exam.id_mat, item_exam
                                        .user_id, exame_pauta, item_exam.sexo, "@"
                                    ])
                                    alunos_recurso += 1;
                                    if (item_exam.sexo == "Feminino") {
