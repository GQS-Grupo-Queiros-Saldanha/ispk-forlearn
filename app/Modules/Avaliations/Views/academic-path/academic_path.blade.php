        ...
        <div class="">
            <div class="">
                    ...
                    <div class="col-12 mb-4">
                        <table class="table_te">
                            ...
                            <tr class="bg1">
                                ...
                                <th style="font-size: 12pt;text-align:center" colspan="2">Filiação</th>
                               
                              
                            </tr>
                            <tr class="bg2">
                                <td  class="bg2 text-left">{{ $studentInfo->dad }}</td> 
                                <td  class="bg2 text-center">{{ $studentInfo->mam }}</td>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="">
                            <div class="">
                                ...
                                <table class="table_te">
                                    <tr class="bg1">
                                        <th colspan="6" style="text-align: center; font-size: 12pt;"><b>UNIDADES
                                                CURRICULARES</b></th>
                                        @php
                                            $i = 0;
                        ...
                        <div class="col-4 float-right mt-4 p-0 mb-8">
                            <table class="mediaClass"
                                ...
                                <tr class="bg1">
                                    <td colspan="2" style="font-size:12pt;text-align: center; font-size: 12pt;">
                                        <b>MÉDIAS</b>
                                    </td>
                                </tr>
                                ...
                                <tr class="bg2"> 
                                    <td style="text-align: right; font-size: 12pt;"><b>MÉDIA FINAL</b></td>
                    ...
                    Percurso académico nº {{$requerimento->code ?? 'código doc'}}, liquidado no Comprovativo de pagamento nº {{$recibo ?? 'recibo'}},
