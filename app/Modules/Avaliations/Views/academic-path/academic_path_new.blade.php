                            ...
                            <tr class="bg2">
                                ...
                                <td class="bg2 text-center">
                                    @if (isset($student_course) && $student_course != '')
                                        {{ $student_course }}@else{{ $studentInfo->course }}
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="bg2 text-center" colspan="3">{{ $studentInfo->dad }} e {{ $studentInfo->mam }}
                                </td>
                            ...
                            <div class="">
                                ...
                                <table class="table_te">
                                    <tr class="bg1">
                                        ...
                                        @php
                                            ...
                                            $oldGradesOrder = collect($oldGrades)
                                ...
                                <div class="col-4 float-right mt-4 p-0 mb-8">
                                    <table class="mediaClass"
                                        ...
                                        <tr class="bg2">
                                            <td style="text-align: right; font-size: 12pt;"><b>MÉDIA FINAL DE CURSO</b>
                                            </td>
                                ...
                                <div style="margin-left:30px;margin-top:150px;">
                                    @if (isset($requerimento))
                                        <p>
                                            ...
                                            Documento nº {{ $requerimento->code ?? 'código doc' }}, liquidado no CP nº
                                            {{ $recibo ?? 'recibo' }},
                                            assinado e autenticado com o carimbo a óleo em uso no
                                            {{ $institution->abrev }}.
                                        </p><br><br><br><br>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <p
                                            style="font-size: 12pt !important;text-align:left;font-weight:bolder !important;margin-bottom:100px !important;">
                                        ...
                                        <p style="font-size: 12pt !important;margin-top:-18px!important;">
                                            ...
                                            <b>{{ $direitor->nome_completo ?? 'Nome completo' }}</b></p>
                                        <p style="font-size:11pt !important;margin-top:-24.5px">
                                            {{ $direitor->categoria_profissional ?? 'Categoria Profissional' }}</p>
                                        <p style="font-size:11pt !important;margin-top:-24px">
                                            {{ $direitor->cargo ?? 'Cargo' }} do {{ $institution->abrev }}</p>
