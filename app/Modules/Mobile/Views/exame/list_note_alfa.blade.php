                        ...
                        <style>
                            ...
                            .tabble_te thead{}
                             ...
                             <tr>    
                                ...
                                <th class="text-center" style="font-size:18pt;font-weight:bold;">Total vagas(s)</th>
                            </tr>
                             <tr>
                    ...
                    <div class="">
                        <div class="">
                            ...
                            @foreach ($estudantes as $item)
                                ...
                                <td class="text-left">  {{$item['cand']==null? "N/A": $item['cand']}}</td> 
                                <td class="text-center">{{$item['nota_a']}}</td>
                                
                                <td class="text-center">{{$item['nota_b']}}</td>
                                <td class="text-center">{{$item['resultado']==0?'-':$item['resultado']}}</td> 
