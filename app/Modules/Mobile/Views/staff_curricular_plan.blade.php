@section('title',"Plano Curricular")
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                     <div class="form-group col-4">
                                         <label style="color:transparent;">um texto qualquer</label>
                                        <a href="" id="btn" class="btn btn-sm btn-info mb-3" target="_blank"><i class="fas fa-file-pdf"></i> Gerar Plano Curricular</a>
                                    </div>
                                </div>
                            </div>
        ...
        $(function () {
            ...
            function switchDataOnDataTable(element) {
             ...
             function getUserId(element) {
                let route = ("{{ route('staff_curricular_plan_ed','id_user') }}").replace('id_user', element.value);
                $.get(route, function (data) {
                    //console.log(data);
                    //location.href = route;
                    document.getElementById('btn').setAttribute('href', route);
                });
            }
