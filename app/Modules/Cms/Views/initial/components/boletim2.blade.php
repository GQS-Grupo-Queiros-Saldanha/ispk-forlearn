                    ...
                    <tr>
                        ...
                        <td colspan="3" class="boletim_text">
                            ...
                            @if (isset($matriculations->course))
                                ...
                                <as class="barra">|</as> Ano0: <b>{{ $matriculations->course_year }}º</b>
                        ...
                        <td class="rec bo1 text-center p-top" colspan="5">EXAME</td>
                ...
                @php
                            if(isset($percurso[$index])){
                                ...
                                if($melhoria_notas->contains('discipline_id',$item_DISC->id_disciplina)){
                                    ...
                                    $melhoria_nota = is_null($m->new_grade) &&  !is_null($m->ausente) ?
                                      0 : !is_null($m->new_grade) ? 
                                      $m->new_grade : null;
                                }
                            }
                    @endphp
