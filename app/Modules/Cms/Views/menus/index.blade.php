@section('title',__('Cms::menus.menus'))
    ...
    <div class="content-panel">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">@lang('Cms::menus.menus')</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('menus.create') }}" class="btn btn-primary btn-sm mb-3">
