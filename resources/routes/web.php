...
Route::group([
    ...
    Route::get('candidaturas', 'CandidatureController@register')->name('candidaturas');
    Route::post('candidaturas', 'CandidatureController@submitData')->name('candidature.submitData');
