...
return [
    ...
    */
    'custom' => [
        ...
        'transaction_fulfilled_at' => [
            'before_or_equal' => 'O Campo Pago a deverá conter uma data anterior ou igual a hoje.'
        ]
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'id_number' => 'Número de Bilhete de identidade',
        'transaction_fulfilled_at' => 'Pago a',
        'today' => 'hoje'
    ],
];
