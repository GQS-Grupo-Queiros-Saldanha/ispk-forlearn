...
class DynamicForms {
    ...
    setupForm(parent, element) {
        ...
        //debug
        //console.log({parent: parent, element: element, fillData: fillData});
    ...
    createNewRow(parent, element, index = undefined, value = undefined) {
        ...
        //debug
        //console.log({cloned: cloned, templateId: templateId, parsedValue: parsedValue});
        ...
        cloned.find("[data-dynamic-form-input-id-template]").each(function (inputKey, inputValue) {
            ...
            //debug
            //console.log({inputElement: inputElement, name: name, id: id, isFirst: isFirst});
            ...
            if (parsedValue !== undefined) {
                ...
                if (typeof parsedValue === 'string') {
                    ...
                    //debug
                    //console.log([name, parsedValue[dynamicName]]);
    ...
    static handleButtons(parent) {
        ...
        // Changed
        parent.find('[data-dynamic-form-remove]').last().show(); //parent.find('[data-dynamic-form-remove]').last().hide();
    }
    ...
    static deepValues(deepValue) {
        ...
        //debug
        //console.log(['deepValues', deepValue]);
        ...
        for (let prop in deepValue) {
            if (deepValue.hasOwnProperty(prop)) {
                ...
                // Changed
                if (typeof deepValue[prop] === 'string' || typeof deepValue[prop] === 'number') { //if (typeof deepValue[prop] === 'string') {
